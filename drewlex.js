...
/* ФУНКЦИОНАЛ:
  1. Блокирование контекстного меню, сохранения страницы, копирования и тд.
...
function initFeatures(settings) {
  ...
  if(typeof settings.protect!="undefined") {
    if(settings.protect==1) {
  ...
  var featuresFilesSrc = {
    ...
    function genLocalCity() {
        var localCities = {
            ...
            'co' : ["Madrid", "Vitoria-Gasteiz", "Segovia", "Salamanca", "Badajoz", "Santander", "A Coruña", "València", "Murcia", "Granada", "Barcelona", "Sevilla", "Toledo", "Cáceres", "Ávila"],
                ...
                'rs': ["Novi Sad", "Kragujevac", "Leskovac", "Niš", "Beograd", "Subotica", "Kruševac", "Kraljevo", "Pančevo", "Zrenjanin", "Šabac", "Čačak", "Smederevo", "Novi Pazar", "Valjevo", "Sombor", "Vranje", "Sremska Mitrovica", "Loznica", "Užice"],
    ...
    function genLocalName() {
        var localNames = {
            ...
            'rs' : [" Miroslav", "Vladimir", "Zoran", " Ljubomir", "Milorad", "Dragan", "Milan", "Goran", "Radomir", "Miomir", "Branimir", "Jovan", "Antonije", "Pavle", "Igor", "Vasilije", "Petar", "Stefan", "Vuk", "Nenad", 'Vesna', 'Radmila', 'Milica', 'Svetlana', 'Slavica', 'Božidarka', 'Aleksandra', 'Petra', 'Malina', 'Lada', 'Biljana', 'Snežana', 'Anka', 'Melania', 'Dragica', 'Dragana', 'Gorana', 'Vladana', 'Nikolina', 'Zorka'],
    ...
    function genGenderWords (whichWord) {
        if (localStorage['sex'] == 1) {
            ...
            var genderWord = {             
                ...
                'rs': ['Učinio sam', 'Stigao sam', 'dobio sam', 'naručio sam', 'naručio sam', 'stigao sam', 'stigao sam', 'znao sam', 'čitao sam', ' naručio sam'],
            ...
            var genderWord = {
                ...
                'rs': ['učinila sam', 'stigla sam', 'dobila sam', 'naručila sam', 'naručila sam', 'stigla sam', 'stigla sam', 'znala sam', 'čitala sam', ' naručila sam'],
    ...
    var commBlocks = {
        ...
        'rs': {
            autoCommWrap: '<div class="comments-refreshing-wrapper"><p class="comments-refreshing-title">Posljednji komentar</p><div class="comments-refreshing"><i>dodaje se novi komentar</i> <br><img src="' + featuresFilesSrc.refreshingArrow + '" alt=""></div>',
            autoComm1: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><span class="comment-username">' + genLocalName() + '</span>' + genGenderWords(0) + ' narudžba ' + genGenderWords(1) + ' sa popustom! Nadam se da će sve biti u redu</div><div class="comment-action"><span class="like">' + commActions[settings.lang].likeWord + '</span><span class="reply">' + commActions[settings.lang].replyWord + '</span><span class="like-count">0</span><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',
            autoComm2: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><span class="comment-username">' + genLocalName() + '</span> Ne brini! Ovo nije prvi put da naručujem ' + settings.product + ', sve narudžbe se dostavljaju netaknute.</div><div class="comment-action"><span class="like">' + commActions[settings.lang].likeWord + '</span><span class="reply">' + commActions[settings.lang].replyWord + '</span><span class="like-count">0</span><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',
            autoComm3: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><span class="comment-username">' + genLocalName() + '</span>Danas ' + genGenderWords(2) + ' ' + settings.product + '. Koristit ću ga, trebalo bi pomoći.</div><div class="comment-action"><span class="like">' + commActions[settings.lang].likeWord + '</span><span class="reply">' + commActions[settings.lang].replyWord + '</span><span class="like-count">0</span><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',
			autoComm4: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><span class="comment-username">' + genLocalName() + '</span> Hvala na prilici za narudžbu sa popustom! I ja prije ' + genGenderWords(3) + ' ' + settings.product + ', ali puno skuplje. Što učiniti, morali ste platiti za učinkovitost, ali isplatilo se.</div><div class="comment-action"><span class="like">' + commActions[settings.lang].likeWord + '</span><span class="reply">' + commActions[settings.lang].replyWord + '</span><span class="like-count">0</span><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',			
			autoComm5: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><span class="comment-username">' + genLocalName() + '</span> Bio sam vrlo impresioniran člankom, pokušat ću. ' + genGenderWords(4) + ' nekoliko komada odjednom, nadam se da pomaže. </div><div class="comment-action"><span class="like">' + commActions[settings.lang].likeWord + '</span><span class="reply">' + commActions[settings.lang].replyWord + '</span><span class="like-count">0</span><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',
            autoComm6: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><span class="comment-username">' + genLocalName() + '</span> Naravno da će pomoći! Za mene ovaj proizvod nije bitan, ali nekoliko mojih poznanika sve je jako koristilo i pohvalilo.</div><div class="comment-action"><span class="like">' + commActions[settings.lang].likeWord + '</span><span class="reply">' + commActions[settings.lang].replyWord + '</span><span class="like-count">0</span><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',
            autoComm7: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><span class="comment-username">Proizvođač ' + settings.product + '</span> Pozornost! S obzirom na činjenicu da ' + settings.product + ' uskoro će se naći u prodaji u ljekarnama, količina robe je ograničena, možda neće biti dovoljno robe za sve. Danas je kupljeno više od 5000 paketa. </div><div class="comment-action"><span class="like">' + commActions[settings.lang].likeWord + '</span><span class="reply">' + commActions[settings.lang].replyWord + '</span><span class="like-count">0</span><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',
            autoComm8: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><span class="comment-username">' + genLocalName() + '</span>' + genGenderWords(5) + '  naručiti nekoliko komada jer planiraju uskoro zaustaviti internetsku prodaju. A u ljekarnama će cijene sigurno biti veće. </div><div class="comment-action"><span class="like">' + commActions[settings.lang].likeWord + '</span><span class="reply">' + commActions[settings.lang].replyWord + '</span><span class="like-count">0</span><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',
			autoComm9: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><span class="comment-username">' + genLocalName() + '</span> Moj prijatelj se danas vratio iz Japana i zamislite - vidio je u ljekarni ' + settings.product + '. Tamo je koštalo oko 70 dolara po paketu, a ljudi kupuju čak i po ovoj cijeni! Nevjerovatno!</div><div class="comment-action"><span class="like">' + commActions[settings.lang].likeWord + '</span><span class="reply">' + commActions[settings.lang].replyWord + '</span><span class="like-count">0</span><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div>',			
			autoComm10: '<div class="comments-item"><div class="comment-avatar"><img src="' + featuresFilesSrc.userAva + '" width="32" height="32"></div><div class="comment-text"><span class="comment-username">' + genLocalName() + '</span>Fuf, ' + genGenderWords(6) + ' naručiti! Hvala, prije ne ' + genGenderWords(7) + ' o ovom alatu. ' + genGenderWords(8) + ' recenzije na Internetu - čini se da su svi sretni, glavna stvar je ne kupiti lažni, pa je bolje naručiti ovdje.</div><div class="comment-action"><span class="like">' + commActions[settings.lang].likeWord + '</span><span class="reply">' + commActions[settings.lang].replyWord + '</span><span class="like-count">0</span><span class="comment-date">' + commActions[settings.lang].justNowWord + '</span></div></div></div>',
              },
